...
from evaluate import evaluate_internal, plot_roc, accuracy, sigmoid, bootstrap, compute_cis
...
class CTClipInference(nn.Module):
    def __init__(
        ...
        *,
        num_train_steps,
        batch_size,
        data_folder: "/kaggle/working/train_preprocessed/train_PE",
        reports_file: "/kaggle/working/train_reports.csv",
        lr = 1e-4,
        wd = 0.,
        max_grad_norm = 0.5,
        ...
        labels = "/kaggle/working/labels/inferred.csv",
        ...
        self.dl_iter=self.dl_iter = iter(cycle(self.dl))
            ...
            with torch.no_grad():
                ...
                for model, filename in models_to_evaluate:
                    ...
                    pathologies = ['Medical material','Arterial wall calcification', 'Cardiomegaly', 'Pericardial effusion',
                                   ...
                                   'Atelectasis', 'Lung nodule','Lung opacity', 'Pulmonary Embolism', 'Pleural effusion', 
